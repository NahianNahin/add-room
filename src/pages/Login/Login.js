...
const Login = () => {
    ...
    const onSubmit = data => {
      ...
      const saveUserDetails = (details, email) => {
        fetch(`https://sweet-home-server-nahiannahin.vercel.app/users?email=${email}`, {
            method: 'PUT',
            headers: {
            ...
            <div className='flex justify-center items-center my-[150px]'>
                <div className='shadow-xl p-7 rounded-2xl w-[400px] border-t-2 border-primary'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <p className='text-xs text-center'>New to Sweet Home? <span className='text-secondary font-bold'><Link to='/signup'>Create new account</Link></span></p>
                    </form>
